  ...
  >
    <div class="flex items-start justify-between gap-3">
      <div>
        ...
        <p v-if="task.description" class="mt-1 text-sm text-slate-300">
          {{ task.description }}
        </p>
      </div>
      <span
    ...
    <div class="flex flex-wrap gap-2">
      ...
      <span v-if="task.tags.length === 0" class="text-xs text-slate-400">No tags</span>
    </div>
